    ...
    <div className='mt-4 text-sm'>
        {menuItems.map((i) => (
          <div className="flex flex-col gap-2 " key={i.title}>
            ...
            {i.items.map((item)=>(
              <Link href={item.href} key={item.label} className="flex items-center justify-center lg:justify-start gap-4 text-gray-500 py-2 hover:bg-lamaSkyLight p-2 rounded-lg ">
